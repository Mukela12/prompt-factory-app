...
- `/packages/shared`: Shared runtime utilities consumed by both server and web. Uses explicit subpath exports (e.g. `@prompt-factory/shared/git`, `@prompt-factory/shared/DrainableWorker`) — no barrel index.
