...
describe("merge-update-manifests", () => {
  it("merges arm64 and x64 macOS update manifests into one multi-arch manifest", () => {
    const arm64 = parsePlatformUpdateManifest(
      ...
      `version: 0.0.4
files:
  - url: Prompt-Factory-0.0.4-arm64.zip
    sha512: arm64zip
    size: 125621344
  - url: Prompt-Factory-0.0.4-arm64.dmg
    sha512: arm64dmg
    size: 131754935
path: Prompt-Factory-0.0.4-arm64.zip
sha512: arm64zip
...
`,
    ...
    const x64 = parsePlatformUpdateManifest(
      ...
      `version: 0.0.4
files:
  - url: Prompt-Factory-0.0.4-x64.zip
    sha512: x64zip
    size: 132000112
  - url: Prompt-Factory-0.0.4-x64.dmg
    sha512: x64dmg
    size: 138148807
path: Prompt-Factory-0.0.4-x64.zip
sha512: x64zip
...
`,
    ...
    assert.deepStrictEqual(
      ...
      [
        "Prompt-Factory-0.0.4-arm64.zip",
        "Prompt-Factory-0.0.4-arm64.dmg",
        "Prompt-Factory-0.0.4-x64.zip",
        "Prompt-Factory-0.0.4-x64.dmg",
      ],
    );
  ...
  it("merges arm64 and x64 Windows update manifests into one multi-arch manifest", () => {
    const arm64 = parsePlatformUpdateManifest(
      ...
      `version: 0.0.4
files:
  - url: Prompt-Factory-0.0.4-arm64.exe
    sha512: arm64exe
    size: 125621344
  - url: Prompt-Factory-0.0.4-arm64.exe.blockmap
    sha512: arm64blockmap
    size: 131754
path: Prompt-Factory-0.0.4-arm64.exe
sha512: arm64exe
releaseDate: '2026-03-07T10:32:14.587Z'
`,
    ...
    const x64 = parsePlatformUpdateManifest(
      ...
      `version: 0.0.4
files:
  - url: Prompt-Factory-0.0.4-x64.exe
    sha512: x64exe
    size: 132000112
  - url: Prompt-Factory-0.0.4-x64.exe.blockmap
    sha512: x64blockmap
    size: 138148
path: Prompt-Factory-0.0.4-x64.exe
sha512: x64exe
releaseDate: '2026-03-07T10:36:07.540Z'
`,
      "latest-win-x64.yml",
    ...
    assert.deepStrictEqual(
      merged.files.map((file) => file.url),
      [
        "Prompt-Factory-0.0.4-arm64.exe",
        "Prompt-Factory-0.0.4-arm64.exe.blockmap",
        "Prompt-Factory-0.0.4-x64.exe",
        "Prompt-Factory-0.0.4-x64.exe.blockmap",
      ],
    );
...
`,
    ...
    const secondary = parsePlatformUpdateManifest(
      ...
      `version: 0.0.5
files:
  - url: Prompt-Factory-0.0.5-x64.exe
    sha512: x64exe
    size: 1
releaseDate: '2026-03-07T10:36:07.540Z'
`,
  ...
  it("preserves quoted scalars as strings", () => {
    const manifest = parsePlatformUpdateManifest(
      ...
      `version: '1.0'
files:
  - url: Prompt-Factory-1.0-x64.zip
    sha512: zipsha
    size: 1
releaseName: 'true'
...
`,
  ...
  it("round-trips numeric-looking versions as strings", () => {
    const original = parsePlatformUpdateManifest(
      ...
      `version: '1.0'
files:
  - url: Prompt-Factory-1.0-x64.exe
    sha512: exesha
    size: 1
releaseDate: '2026-03-07T10:36:07.540Z'
`,
...
`;
  ...
  it.effect("writes the merged manifest back to the primary path by default", () =>
    Effect.gen(function* () {
      ...
      assert.ok(merged.includes("Prompt-Factory-0.0.4-arm64.zip"));
      assert.ok(merged.includes("Prompt-Factory-0.0.4-x64.zip"));
...
`,
      ...
      assert.ok(merged.includes("Prompt-Factory-0.0.4-arm64.exe"));
      assert.ok(merged.includes("Prompt-Factory-0.0.4-x64.exe"));
    }),
  );
