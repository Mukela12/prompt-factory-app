...
it.layer(NodeServices.layer)("build-desktop-artifact", (it) => {
  ...
  it("switches desktop packaging product names to nightly for nightly builds", () => {
    assert.equal(resolveDesktopProductName("0.0.17"), "Prompt Factory");
    assert.equal(resolveDesktopProductName("0.0.17-nightly.20260413.42"), "Prompt Factory Nightly");
  });
        ...
        Effect.provide(
          ConfigProvider.layer(
            ConfigProvider.fromEnv({
              env: {
                PROMPTFACTORY_DESKTOP_SKIP_BUILD: "true",
                PROMPTFACTORY_DESKTOP_KEEP_STAGE: "true",
                PROMPTFACTORY_DESKTOP_SIGNED: "true",
                PROMPTFACTORY_DESKTOP_VERBOSE: "true",
                PROMPTFACTORY_DESKTOP_MOCK_UPDATES: "true",
              },
            }),
          ),
        ),
