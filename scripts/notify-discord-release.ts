  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Prompt Factory prerelease is available for nightly testers."
          : "A new Prompt Factory latest release is available.",
...
).pipe(Command.withDescription("Post a Prompt Factory release announcement to Discord."));
