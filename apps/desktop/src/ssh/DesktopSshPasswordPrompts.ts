import type { DesktopSshPasswordPromptRequest } from "@prompt-factory/contracts";
import { DesktopSshPasswordPromptResolutionInputSchema } from "@prompt-factory/contracts";
import type { SshPasswordRequest } from "@prompt-factory/ssh/auth";
...
const WINDOW_UNAVAILABLE_MESSAGE = "Prompt Factory window is not available for SSH authentication.";
...
>()("prompt-factory/desktop/SshPasswordPrompts") {}
