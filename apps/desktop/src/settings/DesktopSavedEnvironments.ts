import { EnvironmentId, type PersistedSavedEnvironmentRecord } from "@prompt-factory/contracts";
import { fromLenientJson } from "@prompt-factory/shared/schemaJson";
...
>()("prompt-factory/desktop/SavedEnvironments") {}
