...
>()("prompt-factory/desktop/ShellEnvironment") {}
...
const startMarker = (name: string) => `__PROMPTFACTORY_ENV_${name}_START__`;
const endMarker = (name: string) => `__PROMPTFACTORY_ENV_${name}_END__`;
