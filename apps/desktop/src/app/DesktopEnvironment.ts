...
>()("prompt-factory/desktop/Environment") {}

const APP_BASE_NAME = "Prompt Factory";
...
const makeDesktopEnvironment = Effect.fn("desktop.environment.make")(function* (
  ...
  const baseDir = Option.getOrElse(config.t3Home, () =>
    path.join(homeDirectory, ".promptfactory"),
  );
  ...
  const userDataDirName = isDevelopment ? "prompt-factory-dev" : "prompt-factory";
  const legacyUserDataDirName = isDevelopment ? "Prompt Factory (Dev)" : "Prompt Factory";
  ...
  return DesktopEnvironment.of({
    ...
    branding,
    displayName,
    appUserModelId: isDevelopment ? "com.promptfactory.app.dev" : "com.promptfactory.app",
    linuxDesktopEntryName: isDevelopment ? "prompt-factory-dev.desktop" : "prompt-factory.desktop",
    linuxWmClass: isDevelopment ? "prompt-factory-dev" : "prompt-factory",
    userDataDirName,
    ...
    developmentDockIconPath: path.join(
      ...
      "assets",
      "dev",
      "prompt-factory-dev-macos-1024.png",
    ),
  });
});
