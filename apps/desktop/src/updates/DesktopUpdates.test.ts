...
import type { DesktopUpdateState } from "@prompt-factory/contracts";
    ...
    Layer.provide(
      Layer.mergeAll(
        ...
        DesktopConfig.layerTest({
          PROMPTFACTORY_HOME: `/tmp/t3-desktop-updates-test-${process.pid}`,
          PROMPTFACTORY_DESKTOP_MOCK_UPDATES: "true",
          PROMPTFACTORY_DESKTOP_MOCK_UPDATE_SERVER_PORT: "4141",
          ...options.env,
        }),
      ),
    ),
