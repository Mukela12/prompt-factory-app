// This file mostly exists because we want dev mode to say "Prompt Factory (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "Prompt Factory (Dev)" : "Prompt Factory";
const APP_BUNDLE_ID = isDevelopment ? "com.promptfactory.app.dev" : "com.promptfactory.app";
