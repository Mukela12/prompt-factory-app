...
import { parseScopedThreadKey, scopedThreadKey } from "@prompt-factory/client-runtime";
import { type ScopedThreadRef, type TerminalEvent } from "@prompt-factory/contracts";
...
const TERMINAL_STATE_STORAGE_KEY = "prompt-factory:terminal-state:v1";
