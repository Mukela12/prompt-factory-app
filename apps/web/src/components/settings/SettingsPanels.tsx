...
import { scopeThreadRef } from "@prompt-factory/client-runtime";
import { DEFAULT_UNIFIED_SETTINGS } from "@prompt-factory/contracts/settings";
import { createModelSelection } from "@prompt-factory/shared/model";
  ...
  return (
    <SettingsPageContainer>
      <SettingsSection title="General">
        <SettingsRow
          title="Theme"
          description="Choose how Prompt Factory looks across the app."
          resetAction={
            theme !== "system" ? (
