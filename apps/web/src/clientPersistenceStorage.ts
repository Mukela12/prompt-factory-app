...
export const CLIENT_SETTINGS_STORAGE_KEY = "prompt-factory:client-settings:v1";
export const SAVED_ENVIRONMENT_REGISTRY_STORAGE_KEY = "prompt-factory:saved-environment-registry:v1";
