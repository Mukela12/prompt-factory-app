import type { EnvironmentId, ServerConfig } from "@prompt-factory/contracts";
...
export const VERSION_MISMATCH_DISMISSALS_STORAGE_KEY = "prompt-factory:version-mismatch-dismissals:v1";
...
export function resolveVersionMismatch(
  ...
  return {
    ...
    hint: "Version mismatch. Try syncing the client and server to the same Prompt Factory version.",
  };
}
