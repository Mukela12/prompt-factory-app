...
>()("prompt-factory/provider/ProviderMaintenanceRunner") {}
            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but Prompt Factory could not verify the provider version."
                  : stillOutdated
                    ? "Update command completed, but Prompt Factory still detects an outdated provider version."
                    : "Provider updated.",
                output: commandOutput(result),
              }),
            );
