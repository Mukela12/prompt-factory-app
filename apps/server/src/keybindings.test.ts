import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@prompt-factory/contracts";
...
import { KeybindingsConfigError } from "@prompt-factory/contracts";
    ...
    Layer.provideMerge(
      Layer.fresh(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "prompt-factory-keybindings-test-",
        }),
      ),
    ),
  );
