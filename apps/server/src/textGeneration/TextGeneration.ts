...
import type { ChatAttachment, ModelSelection, ProviderInstanceId } from "@prompt-factory/contracts";
import { TextGenerationError } from "@prompt-factory/contracts";
...
export class TextGeneration extends Context.Service<TextGeneration, TextGenerationShape>()(
  "prompt-factory/text-generation/TextGeneration",
) {}
