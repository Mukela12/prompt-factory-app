...
import { CodexSettings, ProviderInstanceId, TextGenerationError } from "@prompt-factory/contracts";
  ...
  return Effect.gen(function* () {
    ...
    yield* fs.writeFileString(
      ...
      [
        ...
        "  cat > \"$output_path\" <<'__PROMPTFACTORY_FAKE_CODEX_OUTPUT__'",
        input.output,
        "__PROMPTFACTORY_FAKE_CODEX_OUTPUT__",
        "fi",
