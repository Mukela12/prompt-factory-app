...
import { EDITORS, OpenError, type EditorId } from "@prompt-factory/contracts";
import { isCommandAvailable, type CommandAvailabilityOptions } from "@prompt-factory/shared/shell";
...
export { OpenError };
export { isCommandAvailable } from "@prompt-factory/shared/shell";
 ...
 */
export class Open extends Context.Service<Open, OpenShape>()("prompt-factory/open") {}
