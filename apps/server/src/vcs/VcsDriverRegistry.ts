...
import type { VcsDriverKind, VcsError, VcsRepositoryIdentity } from "@prompt-factory/contracts";
import { VcsUnsupportedOperationError } from "@prompt-factory/contracts";
...
export class VcsDriverRegistry extends Context.Service<VcsDriverRegistry, VcsDriverRegistryShape>()(
  "prompt-factory/vcs/VcsDriverRegistry",
) {}
