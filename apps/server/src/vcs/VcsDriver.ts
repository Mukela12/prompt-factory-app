...
import { CheckpointRef } from "@prompt-factory/contracts";
...
export class VcsDriver extends Context.Service<VcsDriver, VcsDriverShape>()("prompt-factory/vcs/VcsDriver") {}
