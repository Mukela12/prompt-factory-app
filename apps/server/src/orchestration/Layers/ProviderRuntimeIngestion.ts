...
import { makeDrainableWorker } from "@prompt-factory/shared/DrainableWorker";
...
const STRICT_PROVIDER_LIFECYCLE_GUARD = process.env.PROMPTFACTORY_STRICT_PROVIDER_LIFECYCLE_GUARD !== "0";
