...
import { SourceControlProviderError, type ChangeRequest } from "@prompt-factory/contracts";
...
export const makeDiscovery = Effect.fn("makeBitbucketSourceControlProviderDiscovery")(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set PROMPTFACTORY_BITBUCKET_EMAIL and PROMPTFACTORY_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request and repository scopes).",
