...
import { GitCommandError, TextGenerationError } from "@prompt-factory/contracts";
              ...
              JSON.stringify([
                {
                  ...
                  url: "https://github.com/Mukela12/prompt-factory-app/pull/1661",
                  baseRefName: "main",
                  headRefName: "main",
                  state: "OPEN",
              ...
              "effect-atom": JSON.stringify([
                {
                  number: 1618,
                  title: "Correct PR",
                  url: "https://github.com/Mukela12/prompt-factory-app/pull/1618",
                  baseRefName: "main",
              ...
              "upstream/effect-atom": JSON.stringify([
                {
                  number: 1518,
                  title: "Wrong PR",
                  url: "https://github.com/Mukela12/prompt-factory-app/pull/1518",
                  baseRefName: "main",
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            ...
            url: "https://github.com/Mukela12/prompt-factory-app/pull/642",
            baseRefName: "main",
